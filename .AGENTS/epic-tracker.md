...
- A4 LangSmith tracing setup: env contract and smoke script added; real trace requires user-provided LangSmith and Anthropic keys.
...
- Fill `.env` with real GitHub, Anthropic, and LangSmith values.
